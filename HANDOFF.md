...
- [WARN] html_ui: Font size violation(s): line 190: fixed 48px
- [WARN] html_ui: Font size violation(s): line 191: fixed 48px
- [ERROR] property_patrol_steps: [ESCALATED: 15d unresolved] 物件パトロール失敗ステップ (2026-04-10 18:54): 【問い合わせ文面生成】エラー終了 (exit 1) → Fix: エラーログを確認
- [ERROR] property_patrol_steps: [ESCALATED: 15d unresolved] 物件パトロール失敗ステップ (2026-04-10 18:54): 【内覧分析レポート】異常終了: '<' not supported between instances of 'str' and 'NoneType' → Fix: エラーログを確認
- [ERROR] blank_cells: [ESCALATED: 14d unresolved] ダッシュ「—」169個 (閾値20) — データ欠損の可能性
