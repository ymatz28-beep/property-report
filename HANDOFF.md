...
- [ERROR] structural_reform: [ESCALATED: 16d unresolved] Stale temp/debug file (27 days old). Delete it.
- [ERROR] structural_reform: [ESCALATED: 16d unresolved] Stale temp/debug file (27 days old). Delete it.
- [ERROR] structural_reform: [ESCALATED: 16d unresolved] Stale temp/debug file (27 days old). Delete it.
...
- [ERROR] blank_cells: [ESCALATED: 16d unresolved] ダッシュ「—」164個 (閾値20) — データ欠損の可能性
...
- [ERROR] qa_market_data_accuracy: [ESCALATED: 16d unresolved] 4/91 (4.4%) — price mismatch: コーポラス東光 206 raw=650.0 html=800.0; price mismatch: 三愛シティライフ小笹 204 raw=950.0 html=990.0; price mismatch: ふれんず物件(中央区) raw=800.0 html=950.0; price mismatch: 第一大楠マンション 507 raw=580.0 html=650.0
- [ERROR] qa_market_oc_income_coverage: [ESCALATED: 16d unresolved] OC 309件中 201件が年間収入欠落 (65%) — 利回り逆算で補完
...
- [ERROR] qa_market_name_cross_reference: [ESCALATED: 16d unresolved] 31件の物件名クロスリファレンス不一致: 福岡市博多区千代(26㎡): ['JGM県庁口 502', '■■■【福岡']; 福岡市博多区博多駅前(19㎡): ['・38,000円/月にて賃貸中・保証会社有り・三駅にも近いため、賃貸退居後の自己使用も可能・', 'ソシオス平尾']; 福岡市博多区博多駅前(22㎡): ['ピュアドームエクセル博多', 'ふれんず物件(博多区)', 'ライオンズステーションプラザ博多 7階部分']; 福岡市博多区博多駅南(22㎡): ['ふれんず物件(博多区)', 'ライオンズステーションプラザ博多 7階部分']; 福岡市博多区(25㎡): ['ふれんず物件(博多区)', '◆月々62,000円で賃貸中\u3000駅徒歩13分\u3000オーナーチェンジ'] ... +26 more
