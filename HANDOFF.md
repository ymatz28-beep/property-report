...
---
**📍 今どこ**: 業者選定が難航。RenoLIVING返信待ち・追加候補の探索が必要（2026-06-23）。
**✅ 前回(2026-06-23)**: 3社の選定結果が出た。はぴりの！→旅館業非対応で除外。ANDHEART→費用高額で費用対効果NG。RenoLIVING→まだ返信なし（待機中）。実質1社待ち状態。
**▶ 次**: (1) RenoLIVING返信を待つ（期限を設けて追加候補を並行探索）。(2) 旅館業対応・予算550〜600万・福岡の追加リノベ業者をリサーチ。(3) 公庫審査結果待ち（追加書類要求が来たら即対応）。(4) 組合加入手続き進める — 旅館組合(092-291-1517)・福岡市ホテル旅館組合(092-431-3001)に連絡済み。どちらが公庫振興事業貸付の条件を満たす生活衛生同業組合かを要確認。中野さん対応は一旦完了。
---
