...
## [Constancy] 2026-04-30
- [WARN] data_freshness: Property Status: last updated 29h ago (threshold: 28h)
- [ERROR] hardcoded_data: [ESCALATED: 15d unresolved] Large inline data (91 lines) at line 36. Consider externalizing to YAML/JSON or add `# kaizen-allow: hardcoded_data` 3 lines above to suppress.
- [ERROR] structural_reform: [ESCALATED: 15d unresolved] generate_market.py is 1664 lines (threshold: 800). Consider splitting.
- [ERROR] structural_reform: [ESCALATED: 15d unresolved] property_pipeline.py is 2279 lines (threshold: 800). Consider splitting.
- [ERROR] structural_reform: [ESCALATED: 15d unresolved] Stale temp/debug file (26 days old). Delete it.
- [ERROR] structural_reform: [ESCALATED: 15d unresolved] Stale temp/debug file (26 days old). Delete it.
- [ERROR] structural_reform: [ESCALATED: 15d unresolved] Stale temp/debug file (26 days old). Delete it.
- [ERROR] structural_reform: [ESCALATED: 15d unresolved] Stale temp/debug file (30 days old). Delete it.
- [ERROR] structural_reform: [ESCALATED: 15d unresolved] Stale temp/debug file (34 days old). Delete it.
- [ERROR] html_ui: [ESCALATED: 15d unresolved] Font size violation(s): line 190: fixed 48px
- [ERROR] html_ui: [ESCALATED: 15d unresolved] Font size violation(s): line 191: fixed 48px
- [ERROR] html_ui: [ESCALATED: 15d unresolved] Font size violation(s): line 191: fixed 48px
- [ERROR] html_ui: [ESCALATED: 15d unresolved] Font size violation(s): line 190: fixed 48px
- [ERROR] html_ui: [ESCALATED: 15d unresolved] Font size violation(s): line 190: fixed 48px
- [ERROR] html_ui: [ESCALATED: 15d unresolved] Font size violation(s): line 190: fixed 48px
- [ERROR] html_ui: [ESCALATED: 15d unresolved] Font size violation(s): line 191: fixed 48px
- [ERROR] github_actions_health: Property Patrol: 'Property Pipeline' 6回連続失敗. `gh run view --repo ymatz28-beep/property-report --log-failed` で確認
- [ERROR] blank_cells: [ESCALATED: 15d unresolved] ダッシュ「—」164個 (閾値20) — データ欠損の可能性
- [ERROR] first_seen_coverage: 掲載日カバレッジ 5% (7/133) — 閾値80%
- [ERROR] property_name_quality: 駅名が物件名になっている: 1件 — ['ウィンシティ上野タワー（駅徒歩3分・9階部分・角部屋東向き）']
- [ERROR] qa_market_duplicate_detection: [ESCALATED: 15d unresolved] 1 duplicate (price, area) pairs: [(('19500', '419.4'), ['tokyo-ittomono', 'tokyo-ittomono'])]
- [ERROR] qa_market_data_accuracy: [ESCALATED: 15d unresolved] 4/91 (4.4%) — price mismatch: コーポラス東光 206 raw=650.0 html=800.0; price mismatch: 三愛シティライフ小笹 204 raw=950.0 html=990.0; price mismatch: ふれんず物件(中央区) raw=800.0 html=950.0; price mismatch: 第一大楠マンション 507 raw=580.0 html=650.0
- [ERROR] qa_market_oc_income_coverage: [ESCALATED: 15d unresolved] OC 309件中 201件が年間収入欠落 (65%) — 利回り逆算で補完
