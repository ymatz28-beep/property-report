...
- [ERROR] design_token_compliance: [SISYPHEAN×1: re-appeared after recent fix] Line 703: hardcoded #6366f1 should be var(--accent)
- [ERROR] design_token_compliance: [SISYPHEAN×2: re-appeared after recent fix] Line 758: hardcoded #6366f1 should be var(--accent)
